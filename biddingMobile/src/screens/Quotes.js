...
const Quotes = () => {
  ...
  React.useEffect(() => {
    ...
    setremarkRefs((remarkRefs) =>
      Array(arrLength)
        .fill()
        .map((_, i) => remarkRefs[i] || React.createRef()),
    );
  }, [arrLength]);
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text style={{color: 'white', paddingLeft: 8, paddingTop: 2}}>
                  Price
                </Text>
                {showT[index].val ? (
                  <View>
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        <MaterialIcons name="done" size={18} color="green" />
                      </TouchableOpacity>
                      <TouchableOpacity
                        onPress={() => {
                          resetPrice(index);
